...
#pragma warning disable
    ...
    public partial class MantisHTTPClient : IMantisHTTPClient
    {
        ...
        public async Task<CreateIssueResponse> IssueGetAsync(long id)
        {
            return await IssueGetAsync(id, System.Threading.CancellationToken.None);
        }
        ...
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<UserAddResponse> UserAddAsync(MantisUser body)
        {
        ...
        /// <returns>User successfully created</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public UserAddResponse UserAdd(MantisUser body)
        {
        ...
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        public async System.Threading.Tasks.Task<UserAddResponse> UserAddAsync(MantisUser body, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
        ...
        public Task<List<CreateIssueResponse>> IssueGetAsync()
        {
            return IssueGetAsync(System.Threading.CancellationToken.None);
        }

        private async Task<List<CreateIssueResponse>> IssueGetAsync(System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/issues");
            //urlBuilder_.Append("id=").Append(System.Uri.EscapeDataString(ConvertToString(id,System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            var result_ = default(List<CreateIssueResponse>);
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<List<CreateIssueResponse>>(responseData_, _settings.Value);
                                return result_;
                            }
                            catch (System.Exception exception_)
                            {
                        ...
                        return default(List<CreateIssueResponse>);
                    }
                    finally
                    {
                        if (response_ != null)
    ...
    {
        [Newtonsoft.Json.JsonProperty("field", Required = Newtonsoft.Json.Required.Default)]
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.13.37.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class MantisUser
    {
        ...
        public static MantisUser FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<MantisUser>(data);
        }
